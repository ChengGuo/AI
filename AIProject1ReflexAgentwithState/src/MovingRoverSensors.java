 ...
 *
 * @author Cheng Guo
 * @version 1.2 : Updated with boolean array to mark if sample of corresponding tile been collected or not
 * 
...
public class MovingRoverSensors {
	...
	try {
	    ...
	    grabbed= new boolean[x1.length][2];
		...
		//Adding is Grabbed initialization
		grabbed[i][0]=false;
		grabbed[i][1]=false;
    ...
    public boolean getgrabbed(int x,int y) {
	try {
	    return grabbed[x-1][y-1];
